...
enum RobotState   { IDLE, MANUAL, CRASH, SPRING, BLUETOOTH };
...
void bt_fun() {
  ...
  if (currentState != BLUETOOTH) return;

  switch (c) {
    case 'F': MOVEMENT_TYPE = FORWARD;  break;
    case 'B': MOVEMENT_TYPE = BACKWARD; break;
    case 'L': MOVEMENT_TYPE = LEFT;     break;
    case 'R': MOVEMENT_TYPE = RIGHT;    break;
    case 'S': MOVEMENT_TYPE = STOP;     break;
  }
}
...
void ir_fun() {
  ...
  switch (code)
  {
    case 0xE718FF00: MOVEMENT_TYPE = FORWARD;  RECEIVING_REPEAT = 1; break;
    case 0xAD52FF00: MOVEMENT_TYPE = BACKWARD; RECEIVING_REPEAT = 1; break;
    case 0xE31CFF00: MOVEMENT_TYPE = STOP;     RECEIVING_REPEAT = 1; break;
    case 0xF708FF00: MOVEMENT_TYPE = LEFT;     RECEIVING_REPEAT = 1; break;
    case 0xA55AFF00: MOVEMENT_TYPE = RIGHT;    RECEIVING_REPEAT = 1; break;
    case 0x0:
      RECEIVING_REPEAT = 1;
    ...
    // '*' toggles BLUETOOTH mode
    case 0xE916FF00:
      if (currentState != BLUETOOTH) {
        enterState(BLUETOOTH);
      } else {
        enterState(IDLE);
      }
      gotCommand = false;
  ...
  switch (currentState) {
    ...
    case BLUETOOTH:
      ...
      switch (MOVEMENT_TYPE) {
        case FORWARD:  lcd.print("FWD"); break;
        case BACKWARD: lcd.print("BCK"); break;
        case LEFT:     lcd.print("LFT"); break;
        case RIGHT:    lcd.print("RGT"); break;
        case STOP:     lcd.print("STP"); break;
      }
      lcd.setCursor(0, 1);
      lcd.print("[S] ");
...
void wheel_fun() {
  if ((currentState != MANUAL) && (currentState != SPRING) && (currentState != BLUETOOTH)) return;
